...
export default {
    ...
    'updated': "2020-12-11T11:32:39.000Z",
    'excerpt': "Use this template to create a Pagic site with the docs theme. It's built on V8, Rust, and Tokio. Feature Highlights - Secure by default. No file, network, or environment access (unless explicitly enabled). - Su...",
    'cover': undefined,
    'sidebar': [
        {
            "text": "Introduction",
    ...
    'gitalk': React.createElement(Gitalk, { admin: [
            'xcatliu'
        ], clientID: "29aa4941759fc887ed4f", clientSecret: "33e355efdf3a1959624506a5d88311145208471b", id: "introduction/index.html", owner: "xcatliu", pagerDirection: "first", repo: "pagic_template_docs", title: "Introduction" })
};
